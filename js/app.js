...
const TRANSLATIONS = {
    es: {
        ...
        'edu.percentText': 'El {prob}% represente la probabilidad de tener glaucoma, un porcentaje mayor indica un mayor probabilidad de riesgo. Recordar que es un diagnóstico preliminar no definitivo.',
